    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            if row_values:
                ...
                rows.append((row_text, {"source": filename, "type": "csv", "row": int(idx) + 1}))
        return rows
...
def read_xlsx(file_path: str) -> List[Tuple[str, Dict]]:
    try:
        ...
        for idx, row in df.iterrows():
            ...
            if row_values:
                row_text = " | ".join(row_values)
                rows.append((row_text, {"source": filename, "type": "xlsx", "row": int(idx) + 1}))
        return rows
    except Exception as e:
...
# Updated system prompt - cleaner, no numbered citations
...
- Provide direct answers without unnecessary citation numbers or brackets.
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-text">
                <h1>K&B Scout AI</h1>
                <p>Enterprise Document Assistant</p>
            </div>
        </div>
            ...
            <div class="chat-section">
                ...
                <div class="chat-container" id="chatContainer">
                    <div class="message assistant">
                        ...
                        <div class="message-content">
                            <strong>👋 Hello! I'm K&B Scout AI</strong>, your enterprise document assistant.<br><br>
                ...
                <div class="chat-input-container">
                    <input type="text" class="chat-input" id="chatInput" 
                           placeholder="Ask K&B Scout AI about your documents..." 
                           disabled>
...
def chat():
    ...
    try:
        ...
        retrieved = retrieve(collection, client, message)
        ...
        # Generate response with clean formatting
...
if __name__ == '__main__':
    print("Starting K&B Scout AI Enterprise Assistant...")
